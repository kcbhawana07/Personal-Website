    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-blue-50 p-8 font-sans">
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="p-8 space-y-8">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">Second hand Iphone price predictor</h3>
                    <p className="text-gray-600 text-sm mb-3">A machine learning project to predict the price of second-hand iPhones.</p>
                  </div>
          ...
          {/* Footer */}
          <footer className="pt-6 border-t flex flex-col md:flex-row justify-between items-center gap-4">
